...
const BASE =
  "inline-flex touch-manipulation items-center justify-center gap-1.5 whitespace-nowrap rounded-input text-ui font-semibold transition-[background-color,box-shadow,translate] duration-150 ease-paper active:translate-y-px active:shadow-none disabled:pointer-events-none disabled:opacity-50";
